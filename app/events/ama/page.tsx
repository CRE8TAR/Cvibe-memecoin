      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <SimpleHeading text="Community AMA" />
            <p className="mt-6 text-lg text-cyan-50/90">
              Ask questions directly to the CVIBE team and community leaders every first Sunday of the month.
            </p>

            <div className="mt-12 grid gap-8 md:grid-cols-2">
              <SimpleCard title="Next AMA">
                <div className="text-left space-y-2 text-sm">
                  <div>Date: First Sunday of next month</div>
                  <div>Time: 3PM UTC</div>
                  <div>Platform: Discord Voice Channel</div>
                  <div>Duration: 1-2 hours</div>
                </div>
              </SimpleCard>

              <SimpleCard title="How to Participate">
                <ul className="text-left space-y-2 text-sm">
                  <li>• Join our Discord server</li>
                  <li>• Submit questions in advance</li>
                  <li>• Join the voice channel on time</li>
                  <li>• Raise hand to ask live questions</li>
                </ul>
              </SimpleCard>
            </div>
