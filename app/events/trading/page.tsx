      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <SimpleHeading text="Trading Discussion" />
            <p className="mt-6 text-lg text-cyan-50/90">
              Share insights, discuss market trends, and learn from experienced traders daily at 2PM UTC.
            </p>

            <div className="mt-12 grid gap-8 md:grid-cols-2">
              <SimpleCard title="Discussion Topics">
              ...
              <SimpleCard title="Guidelines">
                <ul className="text-left space-y-2 text-sm">
                  <li>• No financial advice</li>
                  <li>• Share educational content only</li>
                  <li>• Be respectful of all opinions</li>
            ...
            <div className="mt-8 flex gap-4 justify-center">
              <SimpleButton href="https://t.me/cvibe_community" color="purple">
                Join Telegram
              </SimpleButton>
