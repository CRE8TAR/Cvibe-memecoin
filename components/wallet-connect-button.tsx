...
export default function WalletConnectButton({
  ...
  const detectAndConnectWallet = async () => {
    ...
    try {
      ...
      if (!ethereum) {
        throw new Error(
          "No crypto wallet found. Please install MetaMask, Coinbase Wallet, or Trust Wallet"
        );
      }
      ...
      if (!ethereum.request) {
        throw new Error(
          "Wallet not properly initialized - please refresh the page"
        );
      }
      ...
      if (err.code === 4001) {
        ...
        errorMessage =
          "No wallet found - please install MetaMask or another crypto wallet";
