...
export default function CoinTravel3D({ startSelector = "#intro", endSelector = "footer" }: CoinTravel3DProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      const footerSection = document.querySelector(endSelector) as HTMLElement | null
  ...
  return (
    ...
    >
      <Coin3D spinSpeed={2.6} metalness={0.95} roughness={0.15} />
    </div>
  )
}
